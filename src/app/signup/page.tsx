...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-[var(--bg-base)] py-20">
      ...
      <div className="w-full max-w-md bg-[var(--bg-panel)] rounded-3xl p-8 border border-[var(--border-subtle)] relative z-10">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-black uppercase tracking-tight text-[var(--text-primary)] mb-2">Create Account</h1>
          <p className="text-[var(--text-secondary)] text-sm">Join Stryder to track your races and results.</p>
        </div>
        ...
        <button className="w-full py-4 rounded-xl bg-[var(--bg-panel-raised)] border border-[var(--border-subtle)] text-[var(--text-primary)] font-bold hover:bg-[var(--bg-base)] transition-colors flex items-center justify-center">
        ...
        <div className="mt-8 text-center text-sm text-[var(--text-secondary)]">
          ...
          <Link href="/login" className="text-[var(--accent)] font-bold hover:text-[var(--accent-dim)]">
            Log in
          </Link>
        </div>
      </div>
